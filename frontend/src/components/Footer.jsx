...
const Footer = () => {
	return (
		<footer className="px-4 divide-y relative mt-28 ">
			...
			<div className="container flex text-white flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
