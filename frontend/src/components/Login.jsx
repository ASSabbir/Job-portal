    ...
    return (
        <div>
            ...
            <div className='flex justify-center items-center'>
                <div className='flex relative text-white  px-40 py-20 gap-30  justify-center items-center  mt-20'>
                ...
                <div className={`w-full bg-cover bg-center max-w-md p-8 space-y-5 rounded-xl    `}>
