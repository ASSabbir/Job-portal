...
import background from '/Rectangle 82.png'
    ...
    return (
        <div>
            ...
            <div className='flex justify-center items-center p-1'>
                <div className='flex relative text-white px-3 md:px-40 md:py-20 gap-30  justify-center items-center  mt-20'>
                ...
                <div className={`w-full bg-cover bg-center max-w-md p-5 md:p-8 space-y-5 rounded-xl    `}>
                    ...
                    <form onSubmit={handelSubmit}  className="space-y-6">
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3    outline-none border-b-1 border-[#05AF2B]" />
                            <div className="flex justify-end text-xs ">
                                <a rel="noopener noreferrer" href="#">Forgot Password?</a>
                            </div>
                        </div>
                        <button className="block w-full p-3 text-center rounded-sm text-white bg-[#05AF2B] hover:bg-green-500 ">Sign in</button>
                    </form>
